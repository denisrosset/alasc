...
object Permutable {
  implicit def seq[A, G:Group:FaithfulPermutationAction:PermutationRepresentations]: Permutable[Seq[A], G] = new PermutableSeq[A, G]
  ...
  implicit def setInt[S <: SetLike[Int, S] with Set[Int], G:Group](representation: Representation[G])(implicit cbf: CanBuildFrom[Nothing, Int, S]): Permutable[S, G] = new PermutableSetInt[S, G](representation)
}
final class PermutableSetInt[S <: SetLike[Int, S] with Set[Int], G:Group](val representation: Representation[G])(implicit cbf: CanBuildFrom[Nothing, Int, S]) extends Permutable[S, G] {
...
final class PermutableSeq[A, G:Group:FaithfulPermutationAction:PermutationRepresentations] extends Permutable[Seq[A], G] {
