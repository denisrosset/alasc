...
trait TransLike[E <: PermElement[E]] extends PartialFunction[Dom, (E, E)] with Iterable[(Dom, (E, E))] {
  ...
  def mapValues[F <: PermElement[F]](f: E => F): Trans[_, F]
}

trait Trans[T <: Trans[T, E], E <: PermElement[E]] extends TransLike[E] {
  def updated(newGens: Iterable[E], allGens: Iterable[E]): T  /** Returns a new transversal extended with s added to its generators. */
}

trait TransCompanion[T[E <: PermElement[E]] <: Trans[T[E], E]] {
