...
object BasicAlgorithms {
  def deterministic[P](implicit givenAlgebra: FiniteGroup[P]): BasicAlgorithms[P] =
    new BasicAlgorithms[P] with BaseSwapDeterministic[P] with BaseChangeFromScratch[P] with SchreierSimsDeterministic[P] with OrdersImpl[P] with SubgroupSearchImpl[P] {
  ...
  def randomized[P](random: Random = Random)(implicit givenAlgebra: FiniteGroup[P]): BasicAlgorithms[P] =
    new BasicAlgorithms[P] with RandomizedAlgorithms with BaseSwapRandomized[P] with BaseChangeFromScratch[P] with SchreierSimsRandomized[P] with OrdersImpl[P] with SubgroupSearchImpl[P] {
      implicit val algebra = givenAlgebra
      implicit val nodeBuilder = new MutableNodeExplicitBuilder[P]
