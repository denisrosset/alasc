...
sealed abstract class BSGSGroup[E <: PermElement[E]] extends PermGroup[BSGSElement[E]] with BSGSOrderings[E] with BSGSSearch[E] with BSGSMutable[E] with BSGSBase[E] {
  // Chain structure
